...
const Contact = () => {
  ...
  return (
    <>
      ...
      <section id="contact" className="section-padding bg-[#F8F8F0]">
                  ...
                  <div className="flex flex-col gap-4">
                    {socialLinks.map((social) => (
                      <a
                        ...
                        className="flex items-center gap-2 text-sm text-neutral-900 hover:text-black 
                                 font-medium transition-colors p-2 
                                 hover:bg-[#F8F8F0] focus:outline-none focus:ring-2 
                                 focus:ring-neutral-500 border border-transparent hover:border-black/20"
                      >
